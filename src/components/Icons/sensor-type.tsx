...
export default function SensorType({ sensorType, status}: iSensorType ) {
    
    const statusColor = status == "operating" ? "#52C41A" : "#ED3833";
    if ((status || sensorType) == null)
    {
        return(<div>
        ...
        return (<svg width="8" height="9" viewBox="0 0 8 9" fill="none" xmlns="http://www.w3.org/2000/svg">
            <circle cx="4" cy="4.5" r="4" fill={statusColor} />
        </svg>)
